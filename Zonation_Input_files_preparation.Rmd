---
title: '**Spatial conservation prioritisation in data-poor countries: a quantitative sensitivity analysis**<h5 style="font-size:100%; font-color:red; font-family: Helvetica">Appendix 2</h5><br>'
...
* This code aimed at automatizing the creation of input files to run the sensitivity analyses of <a href="https://www.helsinki.fi/en/researchgroups/digital-geography-lab/software-developed-in-cbig" target="_blank">`Zonation`</a>, similar to those used in El-Gabbas *et al.* paper:
  ...
  > El-Gabbas, Ahmed; Gilbert, Francis; and Dormann, Carsten F. **Spatial conservation prioritisation in data-poor countries: a quantitative sensitivity analysis**. BMC Ecology (under review).
